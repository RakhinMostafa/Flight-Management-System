        ...
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                ...
                if (!isset($_SESSION['user'])) {
                    ...
                    $sql = "SELECT FL.number AS FLnumber, company, type, B.ID AS bookid, time, B.date,  departure, d_time, arrival, flightTime, C.name AS classname, capacity, price
            ...
            ORDER BY time";
                    ...
                    $sql2 = "SELECT * from passanger where username='" . $user . "'";


                    $result2 = mysqli_query($con, $sql2);

                    if ($rowcount == 0) {
                        echo "<div class='alert alert-info'><strong>Nothing.</strong></div>";
                    } else {
                        $row2 = mysqli_fetch_array($result2);
                        echo "<div class='alert alert-info'>
                        <b>
                        Username      :" . $row2['username'] . "<hr>
                        Name          : " . $row2['firstname'] . " " . $row2['middlename'] . " " . $row2['lastname'] . "<hr>
                        Email         : " . $row2['email'] . "<hr>
                        Phone Number  : " . $row2['cellphone'] . "<hr>
                        Gender        : " . $row2['gender'] . "<hr>
                        BirthDay      : " . $row2['birthday'] . "<hr>
                        </b>
                        </div>
          ...
          <tr>
            ...
            <th>Price</th>
			  ...
			  <div class='col-sm-6'><p class='lead'>Total Paid(no discount): <span >BDT" . $total . "</span></p></div>
			  <div class='col-sm-4'><button type='submit' class='btn btn-primary'>Okay</button></div>
			</div>";
                            echo "</form>";
                            echo "<br>";
                        } else {
                            $dis = ($total * $_SESSION['Discount']) / 100;
                            $total = $total - $dis;
                            echo " </tbody></table>";
                            echo " <form action='pay.php' method='post'>";
                            echo "<div class='row'>
			  ...
			  <div class='col-sm-6'><p class='lead'>Total Paid(with " . $_SESSION['Discount'] . "% Discount): <span >BDT" . $total . "</span></p></div>
			  <div class='col-sm-4'><button type='submit' class='btn btn-primary'>Okay</button></div>
			</div>";
